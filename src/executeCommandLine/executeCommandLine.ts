namespace ts {
    ...
    function reportSolutionBuilderTimes(system: System, builder: SolutionBuilder<BuilderProgram>, buildHost: SolutionBuilderHost<BuilderProgram>) {
        ...
        const times = builder.times();
        buildHost.statistics = append(buildHost.statistics, arrayFrom(times.entries(), ([name, value]) => ({ name: name + " time", value, type: StatisticType.time })));
        builder.clearTimes();
